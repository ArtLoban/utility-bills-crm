...
import { CONTRACT_LIMITS, type TCreateContractForm } from "@/features/contracts/schema";
import { CreateContractFormField } from "@/features/contracts/types";
import { ROUTES } from "@/lib/routes";
import type { TProvider } from "@/lib/db/schema/providers";

type TProps = {
  form: UseFormReturn<TCreateContractForm>;
  providers: TProvider[];
};

export const CreateContractForm = ({ form, providers }: TProps) => {
    ...
    <Form {...form}>
      <FormFields>
        <div>
          <FormSelectField
            control={control}
            name={CreateContractFormField.PROVIDER_ID}
        ...
        <FormDateField
          control={control}
          name={CreateContractFormField.VALID_FROM}
        ...
        <FormTextareaField
          control={control}
          name={CreateContractFormField.NOTES}
