...
export const SaveRow = ({ isDirty, onSave }: TProps) => (
  <>
    {/* Desktop */}
    <div className="border-border mt-2 hidden items-center justify-between rounded-[10px] border bg-zinc-50 p-4 md:flex dark:bg-zinc-900">
      <div className="text-muted-foreground flex items-center gap-2.5 text-[12.5px]">
    ...
    <div className="border-border sticky bottom-0 z-10 border-t bg-white/95 px-4 pt-3 pb-4 backdrop-blur-sm md:hidden dark:bg-zinc-950/95">
      <SaveButton isDirty={isDirty} onSave={onSave} fullWidth />
      <p className="text-muted-foreground mt-1.5 text-center text-[11.5px]">
