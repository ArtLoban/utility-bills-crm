    ...
    <section className="bg-zinc-100/45 py-24 dark:bg-zinc-900/80">
      <div className="mx-auto max-w-[1100px] px-6">
        ...
        <div className="grid grid-cols-1 gap-7 sm:grid-cols-2 sm:gap-10">
          <div>
            <p className="mb-4 text-[13px] font-semibold tracking-[0.06em] text-zinc-900 uppercase dark:text-zinc-200">
            ...
            <div className="flex flex-wrap gap-2">
              {FRONTEND_CHIPS.map((chip) => (
                <span
                  key={chip}
                  className="rounded-md border border-zinc-200 px-[11px] py-1 text-[13px] whitespace-nowrap text-zinc-600 transition-colors hover:border-violet-400/40 hover:text-violet-600 dark:border-zinc-800 dark:text-zinc-400 dark:hover:border-violet-400/50 dark:hover:text-violet-400"
                >
                  {chip}
                </span>
              ))}
