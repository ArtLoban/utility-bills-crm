    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="px-6 py-5">
          ...
          {/* Guidance label */}
          <p className="mb-[14px] text-center text-sm text-zinc-500">
            {t("lastOwnerModal.guidance")}
          </p>

          {/* Numbered steps */}
          <div className="flex flex-col gap-2">
            {([t("lastOwnerModal.step1"), t("lastOwnerModal.step2")] as const).map((text, i) => (
              <div
                key={i}
